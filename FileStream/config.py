...
class Telegram:
    ...
    UPDATES_CHANNEL = str(env.get('UPDATES_CHANNEL', "Filmaze_Bots"))
    SESSION_NAME = str(env.get('SESSION_NAME', 'FileStream'))
    FORCE_SUB_ID = env.get('FORCE_SUB_ID', '-1002650577614')
    ...
    AUTH_USERS = list(set(int(x) for x in str(env.get("AUTH_USERS", "6318243977")).split()))
